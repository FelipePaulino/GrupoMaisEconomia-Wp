...
.bloco_direito{
	...
	<div>
				<div class="banner banner-colegios-celular">
					<div class="container">
						<h2>Economia de água em <span>Colégios/Creches</span></h2>
						<p>Um uso consciente e racional da água é possível também nas escolas.</p>
						<a href="#" class="abrir-modal">Contato</a>
					</div>
				</div>
		<div class="carrosel">
			<div>
				<div class="banner banner-interna-colegios">
					<div class="container">
						<h2>Economia de água em <span>Colégios/Creches</span></h2>
						<p>Um uso consciente e racional da água é possível também nas escolas.</p>
						<a href="#" class="abrir-modal">Contato</a>
		...
		<main>
			...
			<h1>Economia de água em Colégios/Creches</h1>
	 		<p> Um uso consciente e racional da água é possível também nas escolas.</p>
