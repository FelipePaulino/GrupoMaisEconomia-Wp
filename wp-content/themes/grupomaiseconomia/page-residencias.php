...
.bloco_direito{
	height: 60px;
		...
		<div class="banner banner banner-residencias-celular">
			<div class="container">
				<h2>Economia de água em <span>Residências</span></h2>
				<p>Em qualquer domicílio, é preciso preservar a água por meio de um uso racional.</p>
				<a href="#" class="abrir-modal">Contato</a>
			</div>
		</div>
		<div class="carrosel">
			<div>
				<div class="banner banner-interna-residencias">
					<div class="container">
						<h2>Economia de água em <span>Residências</span></h2>
				<p>Em qualquer domicílio, é preciso preservar a água por meio de um uso racional.</p>
						<a href="#" class="abrir-modal">Contato</a>
		...
		<div class="container">
			<main>
				...
				<h1>Economia de água em Residências</h1>
		 		<p>Em qualquer domicílio, é preciso preservar a água por meio de um uso racional.</p>
