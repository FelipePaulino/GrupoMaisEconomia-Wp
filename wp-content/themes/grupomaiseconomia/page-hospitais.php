...
.bloco_direito{
	...
	<div>
				<div class="banner banner-hospitais-celular">
					<div class="container">
						<h2>Economia de água em <span>Hospitais/Clínicas</span></h2>
						<p>Economia de água em Hospitais/Clínicas</p>
						<a href="#" class="abrir-modal">Contato</a>
					</div>
				</div>
		<div class="carrosel">
			<div>
				<div class="banner banner-interna-hospitais">
					<div class="container">
						<h2>Economia de água em <span>Hospitais/Clínicas</span></h2>
						<p>Economia de água em Hospitais/Clínicas</p>
						<a href="#" class="abrir-modal">Contato</a>
		...
		<main>
			...
			<h1>Economia de água em Hospitais/Clínicas.</h1>
	 		<p>A água é muito utilizada nesses estabelecimentos, mas é possível racionalizar seu uso</p>
