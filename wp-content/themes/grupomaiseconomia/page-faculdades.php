...
.bloco_direito{
	...
	<div>
				<div class="banner banner-faculdades-celular">
					<div class="container">
						<h2>Economia de água em <span>Faculdades</span></h2>
						<p>Saiba como reduzir os gastos com consumo de água nas faculdades.</p>
						<a href="#" class="abrir-modal">Contato</a>
					</div>
				</div>
		<div class="carrosel">
			<div>
				<div class="banner banner-interna-faculdades">
					<div class="container">
						<h2>Economia de água em <span>Faculdades</span></h2>
						<p>Saiba como reduzir os gastos com consumo de água nas faculdades.</p>
						<a href="#" class="abrir-modal">Contato</a>
		...
		<main>
			...
			<h1>Economia de água em Faculdades</h1>
	 		<p>Saiba como reduzir os gastos com consumo de água nas faculdades.</p>
